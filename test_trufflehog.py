...
def test_case_06():
    results_06 = os.system(
        "trufflehog git https://github.com/KarolodonerPL/trufflehog-tests.git --results=verified,unknown --json > output_TC6.json")
    return results_06
...
def test_case_08():
    results_08 = os.system("docker run --rm -it -v '%cd:/=\%:/pwd' trufflesecurity/trufflehog:latest github --repo https://github.com/KarolodonerPL/trufflehog-tests.git  --json  > output_TC8.json")
    return results_08
